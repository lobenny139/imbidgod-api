...
import com.imbidgod.jwt.JwtAuthenticationEntryPoint;
import com.imbidgod.jwt.JwtRequestFilter;
...
//		web.ignoring().mvcMatchers("/swagger-resources/**");
...
//		.antMatchers( "/validate").permitAll()
		...
		.antMatchers("HttpMethod.POST", "/member/validate").permitAll()
